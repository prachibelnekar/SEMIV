                    ...
                    {HeroData.map((data) => (
                        <div key={data.id}>
                            <div className="grid grid-cols-1 sm:grid-cols-2">
                                ...
                                <div className="flex flex-col justify-center gap-4 sm:pl-3 pt-12 sm:pt-0  sm:text-left order-2 sm:order-1 relative z-10">
                                ...
                                <div className="order-1 sm:order-2">
                                    <div data-aos="zoom in" data-aos-once="true" className="relative z-10">
                                        <img src={data.img} alt="" className="w-[300px] sm:w-[450px] h-[300px] sm:h-[450px] sm:scale-105 lg:scale-120 object-contain mx-auto drop-shadow-[-8px_4px_6pxrgba(0,0,0,.4)] relative z-40" />
                                    </div>
                                </div>
                            </div>
                        </div>
