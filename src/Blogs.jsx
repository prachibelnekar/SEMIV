...
import Img1 from "../src/assets/blog-1.jpg";
import Img2 from "../src/assets/blog-2.jpg";
import Img3 from "../src/assets/blog-3.jpg";
...
const Blogs = () => {
  return (
    <div className="my-1 bg-white dark:bg-gray-900 dark:text-white h-[636px]">
...
//line-clamp-1 : wrapping up text in a single line